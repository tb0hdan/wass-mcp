...
func (s *NiktoTestSuite) TestFormatOutput_OffsetBeyondEnd() {
	output := "line1\nline2\nline3"
...
func (s *NiktoTestSuite) TestFormatOutput_ZeroMaxLines() {
...
func (s *NiktoTestSuite) TestInput_ValidationValidHostname() {
	input := Input{
		Host: "example.com",
		Port: 443,
	}
...
func (s *NiktoTestSuite) TestInput_ValidationValidIP() {
	input := Input{
		Host: "10.0.0.1",
		Port: 8080,
	}
...
func (s *NiktoTestSuite) TestInput_ValidationEmptyHost() {
